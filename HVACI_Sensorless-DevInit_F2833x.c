...
//============================================================================
//
// FILE:	HVACI_Sensorless-DevInit_F2833x.c
//
...
//	GpioDataRegs.GPASET.bit.GPIO14 = 1;		// uncomment if --> Set High initially
	...
	GpioCtrlRegs.GPAQSEL1.bit.GPIO14 = 2;	// Cuantificación en 6 ciclos para filtrado de la entrada

	GpioIntRegs.GPIOXNMISEL.bit.GPIOSEL=0xE;				// Elijo que DESAT active la interrupción no enmascarable
